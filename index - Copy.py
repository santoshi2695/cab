...
class travel:
    ...
    #==========================================Define Functiom==================================================
        ...
        def Receiptt():
            if reset_counter == 0 and Firstname.get()!="" and Surname.get()!="" and Address.get()!="" and Postcode.get()!="" and Mobile.get()!="" and Telephone.get()!="" and Email.get()!="":
                ...
                self.txtReceipt1.insert(END,'Mini Car:\n')
                self.txtReceipt2.insert(END, Standard.get() + "\n")
                self.txtReceipt1.insert(END,'Sedan:\n')
                self.txtReceipt2.insert(END, FordGalaxy.get() + "\n")
                self.txtReceipt1.insert(END,'Traveller:\n')
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "PHAGWARA":
                    switch ={"JALANDHAR": 20,"LUDHIANA": 40,"CHANDIGARH":125,"PHAGWARA": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "JALANDHAR":
                    switch ={"JALANDHAR": 0,"LUDHIANA": 60,"CHANDIGARH":150,"PHAGWARA": 20}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "LUDHIANA":
                    switch ={"JALANDHAR": 60,"LUDHIANA": 0,"CHANDIGARH":100,"PHAGWARA": 40}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "CHANDIGARH":
                    switch ={"JALANDHAR": 150,"LUDHIANA": 100,"CHANDIGARH":0,"PHAGWARA": 125}
                    Km.set(switch[varl2.get()])        
   ...
   #================================================mainframe========================================================================
    ...
    #===============================================Cab Information==============================================================
        ...
        self.cboPickup['value']=('*Select pickup location*','PHAGWARA','CHANDIGARH','LUDHIANA','JALANDHAR')
        self.cboPickup.current(0)
        ...
        self.cboDrop['value']=('*Select drop location*','JALANDHAR','LUDHIANA','PHAGWARA','CHANDIGARH')
        self.cboDrop.current(0)
        ...
        self.cboPooling['value']=('*Select pool*','1','2','3','4')
        self.cboPooling.current(0)
    ...
    #==========================================================Cabselect=======================================================================
        ...
        self.chkStandard=Radiobutton(Book_Frame,text="MINI CAR",value=1,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=0, column=0, sticky=W)
        ...
        self.chkFordGalaxyd=Radiobutton(Book_Frame,text="SEDAN",value=2,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=1, column=0, sticky=W)
        ...
        self.chkFordMondeo = Radiobutton(Book_Frame,text="TRAVELLER",value=3,variable = carType,font=('arial',14,'bold'),command=selectCar).grid(row=2, column=0)
